  ...
  server.sendContent(F("<script>"
    ...
    "function poll(){"
      ...
      "x.onload=function(){"
        ...
        "var s=gS(d.rssi!=null?d.rssi:-100);"
        "document.getElementById('rssi').textContent=(d.rssi!=null?d.rssi:-100)+' dBm';"
        "document.getElementById('dist').textContent='aprox '+gD(d.rssi,d.txPower);"
      ...
      "x.onerror=x.ontimeout=function(){"
        "document.getElementById('rssi').textContent='X';"
        "document.getElementById('state').textContent='SIN RESPUESTA';"
        "document.getElementById('circle').style.borderColor='#c00';"
        "document.getElementById('status').textContent='WiFi THLS-C001 conectado?';"
      "};"
      "x.send();"
    "}"
    "function toggle(){"
